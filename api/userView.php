...
<body class="bg-info container">
    ...
    ?>
        ...
        <table id="table_id" class="display shadow">
            ...
            <tbody>
                ...
                foreach ($users as $usuario) {
                    echo "<tr >" .
                        ...
                        "<td><a id='UpdateUser'href='?action=actualizar&objeto=" . base64_encode(serialize($usuario)) .
            ...
            <!-- Update user -->
            <div class="modal fade" id="formUpdateUser" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="formNuevoUsuario" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="loader">
                            <div class="lds-facebook">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="title-form">User Update</h5>
                            <button type="button" class="close" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
