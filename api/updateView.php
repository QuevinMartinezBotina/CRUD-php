...
<body>
    <div class="row container ">
        <div class="col-12 shadow mb-4 bg-white ">
            <form action="?action=actualizar" method="post" class=" bg-white container contenedor-guardar-usuarios animacion-lateral pl-md-5 pt-md-4">
